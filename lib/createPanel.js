...
async function createPanel(ctx, { memo, cpu, disk }) {
    ...
    const deskripsi = moment().tz(config.system.timeZone).format("dddd, D MMMM - YYYY");
    ...
    const thumbnails = [
        "https://raw.githubusercontent.com/boyde1317-byte/moonson/main/assets/images/panel-management.jpg",

...
module.exports = {
    ...
    code: async (ctx) => {
        ...
        if (input.toLowerCase() === "reset") {
            ...
            senderDb.sessionId.copilot = ctx.helper.randomUUID();
            senderDb.save();
        ...
        try {
            ...
            // ── Build API URL ──
            const apiUrl = tools.api.createUrl("nexray", "/ai/copilot", {
                text: input,
                session: senderDb.sessionId.copilot
            });
